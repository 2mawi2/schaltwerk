...
function HighlightCutout({ highlightRect }: { highlightRect: DOMRect | null }) {
    ...
    return (
        <>
            <div 
                className="absolute border-4 border-cyan-400 rounded-lg shadow-lg shadow-cyan-400/50 bg-transparent"
                style={{
            ...
            />
            <div 
                className="absolute bg-cyan-400/20 rounded-lg"
                style={{
                ...
                <div className="w-[960px] max-w-[96vw] bg-slate-900 border border-slate-700 rounded-xl shadow-xl overflow-hidden relative z-40">
                    ...
                    <div className="px-6 py-4 border-t border-slate-800 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                onClick={handleNext}
                                className="px-4 py-1.5 bg-cyan-600 hover:bg-cyan-700 text-white rounded text-sm transition-colors flex items-center gap-2"
                            >
