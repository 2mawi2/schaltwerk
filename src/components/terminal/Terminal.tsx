        ...
        >
             ...
             {isAgentTopTerminal && agentStopped && hydrated && terminalEverStartedRef.current && (
                 <div className="absolute inset-0 flex items-center justify-center z-30">
                     <div className="flex items-center gap-2 bg-elevated border border-subtle rounded px-3 py-2 shadow-lg">
                         <span className="text-sm text-secondary">Agent stopped</span>
                          <button
                              onClick={(e) => { e.stopPropagation(); void restartAgent(); }}
                              className="bg-accent-blue hover:opacity-80 text-sm px-3 py-1 rounded font-medium transition-opacity"
                              style={{
